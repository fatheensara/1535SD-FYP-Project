...
class _StudentProfilePageState extends State<StudentProfilePage> {
      ...
      if (!result.hasCard && !_hasShowedNoCardWarning) {
        ...
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(content: Text('No virtual card found. Create one now!'), backgroundColor: Colors.orange),
          );
        }
      }
  ...
  Future<({Map<String, dynamic>? cardData, bool hasCard, String? studentUid})> _repairCardData(String studentUid) async {
    try {
                  ...
                  child: Column(
                    children: [
                      ...
                      if (_isLoadingCard)
                        ...
                        GestureDetector(
                          onTap: () {
                             Navigator.push(context, MaterialPageRoute(builder: (context) => const MyVirtualCard()));
                          },
                          child: _buildVirtualCard(), // Uses the fancy demo design
                        )
                      else
                      ...
                      _buildMenuTile(
                        ...
                        onTap: () => Navigator.push(context, FadePageRoute(page: const StudentNfcPage())),
                      ),
                      _buildMenuTile(
                        icon: Icons.lock_outline,
                        title: "Security",
                        subtitle: "Biometrics & App Lock",
                        onTap: () => Navigator.push(context, FadePageRoute(page: const StudentSecurityPage())),
                      ),
                      _buildMenuTile(
                        icon: Icons.history_rounded,
                        title: "Scan Activity",
                        subtitle: "View recent device handshakes",
                        onTap: () => Navigator.push(context, FadePageRoute(page: const StudentScanActivityPage())),
                      ),
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          child: Text("Log Out", style: GoogleFonts.poppins(fontWeight: FontWeight.bold, fontSize: 16)),
                        ),
                      ),
                    ],
                  ),
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          if (id.isNotEmpty)
            Text(id, style: GoogleFonts.poppins(color: Colors.white70, fontSize: 14)),
        ],
      ),
    );
  }
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text("No Card Found", style: GoogleFonts.poppins(fontWeight: FontWeight.bold, color: Colors.grey.shade600)),
          const SizedBox(height: 15),
          ElevatedButton(
  ...
  Widget _buildVirtualCard() {
    ...
    if (_useGradient) {
      cardDecoration = BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(24),
        boxShadow: [
          BoxShadow(color: _cardColor.withOpacity(0.4), blurRadius: 20, offset: const Offset(0, 10)),
        ],
      );
    } else {
      cardDecoration = BoxDecoration(
          ...
          Row(
            ...
            children: [
              Container(
                ...
                child: Center(child: Icon(Icons.memory, color: Colors.white.withOpacity(0.8), size: 24)),
              ),
              ...
              Row(
                ...
                children: [
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text("STUDENT NAME", style: GoogleFonts.lato(color: Colors.white54, fontSize: 10, fontWeight: FontWeight.bold)),
                      Text(name.toUpperCase(), style: GoogleFonts.poppins(color: Colors.white, fontSize: 16, fontWeight: FontWeight.bold)),
                    ],
                  ),
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.end,
                    children: [
                      Text("VALID THRU", style: GoogleFonts.lato(color: Colors.white54, fontSize: 10, fontWeight: FontWeight.bold)),
                      Text("12/26", style: GoogleFonts.poppins(color: Colors.white, fontSize: 16, fontWeight: FontWeight.bold)),
                    ],
                  ),
                ],
              ),
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Text("Effect Style", style: GoogleFonts.lato(fontWeight: FontWeight.bold, color: Colors.grey.shade700)),
              Row(
                children: [
                  Text("Solid", style: GoogleFonts.lato(fontSize: 12, color: !_useGradient ? Colors.black : Colors.grey)),
                  Switch(
                    value: _useGradient,
                  ...
                  Text("Gradient", style: GoogleFonts.lato(fontSize: 12, color: _useGradient ? Colors.black : Colors.grey)),
                ],
              ),
            ],
          ),
          ...
          Text("Base Color", style: GoogleFonts.lato(fontWeight: FontWeight.bold, color: Colors.grey.shade700)),
          const SizedBox(height: 10),
          SizedBox(
            height: 50,
                ...
                return GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      boxShadow: [
                        if (isSelected)
                          BoxShadow(color: c.withOpacity(0.5), blurRadius: 8, offset: const Offset(0, 2)),
                      ],
                    ),
  ...
  Widget _buildSectionTitle(String title) {
    return Padding(
      ...
      child: Align(
        ...
        child: Text(title, style: GoogleFonts.poppins(fontSize: 16, fontWeight: FontWeight.w600, color: Colors.grey.shade800)),
      ),
    );
  }
