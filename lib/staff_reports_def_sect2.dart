...
class _StaffReportsDefSect2PageState extends State<StaffReportsDefSect2Page> {
  ...
  final List<Map<String, dynamic>> _allStudents = [
    ...
    {"name": "Noah R.", "w1_7": 79.0, "w1_14": 81.0}, // Warning
    ...
    {"name": "Sam E.", "w1_7": 76.0, "w1_14": 82.0}, // Warning
    ...
    {"name": "Alan T.", "w1_7": 77.0, "w1_14": 80.0}, // Warning
    ...
    {"name": "Faith H.", "w1_7": 75.0, "w1_14": 80.0}, // Warning
    ...
    {"name": "Max C.", "w1_7": 78.0, "w1_14": 79.0}, // Warning
    ...
    try {
      ...
      for (var student in targetList) {
        ...
        batch.set(docRef, {
          ...
          'courseCode': 'CSCI 4332', // UPDATED COURSE CODE
          'type': type,
          'title': title,
          'message': message,
  ...
  Future<void> _downloadPdfReport() async {
    try {
      ...
      final file = File("${output.path}/DEF_Section2_Full_Report.pdf");
      await file.writeAsBytes(pdfBytes);
      await Share.shareXFiles([
        XFile(file.path),
      ], text: 'Attendance Report (DEF Sect 2)');
    } catch (e) {
      if (mounted)
        ScaffoldMessenger.of(
          context,
  ...
  Future<void> _sendReportToAdmin() async {
    ...
    try {
      ...
      await FirebaseFirestore.instance.collection('admin_reports').add({
        'courseCode': 'CSCI 4332', // UPDATED COURSE CODE
        'courseName': 'Digital Evidence Forensics',
        'section': '02',
      ...
      await FirebaseFirestore.instance.collection('admin_notifications').add({
        ...
        'message': 'New Report: CSCI 4332 (Sect 2)',
