...
class StaffCoursesPitsSect2Page extends StatefulWidget {
  const StaffCoursesPitsSect2Page({super.key});

  @override
  State<StaffCoursesPitsSect2Page> createState() =>
      _StaffCoursesPitsSect2PageState();
}

class _StaffCoursesPitsSect2PageState extends State<StaffCoursesPitsSect2Page>
                  ...
                  child: Column(
                    ...
                    children: [
                      Container(
                        ...
                        child: Text(
                          "CSCI 2303 • SECTION 2", // UPDATED SECTION
                      ...
                      Row(
                        children: [
                          ...
                          Text(
                            " Mon & Wed 10:00 - 11:30 • Lab 1", // UPDATED TIME/VENUE
  ...
  // --- TAB 1: MATERIALS (Same modules, different state if needed) ---
    ...
    return ListView(
      ...
      children: [
        _buildModuleCard(
          ...
          isExpanded: false, // Collapsed by default for Section 2
        ),
        _buildModuleCard(
          ...
          isExpanded: true, // Currently working on Week 2
        ),
  ...
  // --- TAB 3: STUDENTS (Different List for Section 2) ---
  Widget _buildStudentsTab() {
    // Mock List for Section 2
        ...
        return Container(
          ...
          child: Row(
            children: [
              CircleAvatar(
                backgroundColor:
                    Colors.orange.shade50, // Different Color for Sect 2
                child: Text(
                  students[index][0],
                  style: GoogleFonts.poppins(
                    fontWeight: FontWeight.bold,
